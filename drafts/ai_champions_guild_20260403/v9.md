...
*Draft v9 | FDE Identification + AI Practitioner Expansion + VCN Integration | 2026-04-11 | ~2,700 words*
...
## Revision Notes (v9 — 2026-04-11)
- **FDE identification added as Job 4**: Defines what a Forward Deployed Engineer is, why the profile is rare, and why the Guild is the right identification mechanism — not a staffing process
- **FDE career path added**: Extended Career benefits section to name the Guild as EPAM NA's FDE pipeline, not just an internal progression track
- **AI practitioner population expanded**: "Who Belongs" now distinguishes badge-based membership from the broader target population of practitioners doing meaningful SDLC AI work — active scouting through BU Communities and VCN, not passive credential-waiting
- **AI VCN integration section added**: New section between "How the Guild is Organized" and "The Four Jobs" — covers infrastructure reuse, VCN as discovery pipeline, and the Guild/VCN division of function
- **All prior structural elements preserved**: Launch plan, failure modes, diagnostic, member benefits, community rationale unchanged
