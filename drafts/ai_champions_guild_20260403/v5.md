...
*Draft v5 | Post-Revision | 2026-04-03 | ~1,480 words*
...
The specificity of the mandate is what makes the community work. The Guild exists to make EPAM NA better at winning and delivering AI-enabled work. That's narrow enough to be useful and consequential enough to justify the investment.
...
EPAM NA doesn't have this problem. It has a credential system that already identifies who has demonstrated relevant capability. Guild membership draws directly from it.

**The core tier — Guild Members:**

- **AI Champions** (67): The founding cohort. These individuals have already shifted a real project team's AI posture. Their experience is operational, not theoretical. Nearly half are B-track (35 managers and consultants) — this isn't a developer-only club.
...
- **EngX AI Productivity Experts** (9): The rarest badge in the pool. These nine are trained to measure AI-driven productivity gains inside active engagements. For a services company, that capability is commercially significant — it's how you prove ROI to a client.
- **AI Architect Graduates** (15): Trained to architect AI solutions. Fourteen of fifteen are B-track, which aligns with how this credential is used: these are the people advising on solution design in consulting contexts.

That's the founding membership pool: roughly 206 people who have earned their way in.

**On badge currency.** "Earned, not self-selected" is the right principle — but leadership will ask: earned when? The Guild treats badge status as a starting filter, not a permanent credential. Active membership requires contribution: at least one proposal, workshop, or use-case sprint per quarter. The program lead tracks engagement. Members who go dark move to the pipeline tier. A roster of 206 people who once held badges is not the same as 206 people who are engaged and current. The distinction matters for any account lead staffing an AI-scoped engagement.

**The pipeline tier — Guild-Eligible:**

The **AI Ready** badge (41 people) and active program participants represent the population approaching guild-eligible status. The Guild should track this group deliberately — they're where membership growth comes from.

One structural note: the A-track and B-track split across badge types is not accidental, and the Guild has to bridge it deliberately. B-track dominates the senior, strategic badges; A-track leads in delivery-focused Practitioners. A proposal needs both. An accurate estimate for an AI-enabled engagement needs both. Design the Guild's operating model to mix these populations, not silo them.
...
**Ownership concentration**: Two or three people carry everything. Burnout is guaranteed. Prevention: distributed contribution across 206 members and the quarterly engagement threshold, which keeps the active pool genuinely active rather than concentrated in a core of volunteers who exhaust themselves.
...
## Revision Notes
- **Critic Issues Addressed**: Restored community-of-practice framing per user correction. Four targeted changes made.
- **Structural Changes**: Section 2 retitled and reframed ("A Community of Practice — With a Commercial Mandate"). Three Jobs section gained flywheel paragraph. What Members Do section restructured into explicit "what members contribute / what members get" with peer community addition. Closing paragraph updated to echo community-plus-mandate framing.
- **Evidence Added**: No new external sources. Peer cohort value articulated from first principles consistent with existing argument.
- **Sections Rewritten**: "This Is Not a Community of Practice" (full reframe), "What Members Do — and What They Get" (restructured with additions), closing of "The Diagnostic" (two sentences updated).
- **Outstanding Issues**: None. All four specified changes implemented. Preserved phrases confirmed: "unit of impact," "not a leadership failure — it's physics," closing diagnostic paragraph, opening inventory paragraph, badge model, three commercial jobs, A/B-track career logic.

## Publication Metadata
- **Word Count**: ~1,480
- **Reading Time**: 6 minutes
- **Target Audience**: EPAM NA leadership — account leads, delivery leaders, practice heads
- **Key Topics**: AI Champions Guild, EPAM NA, capability activation, AI-enabled delivery, community of practice, proposal excellence, workforce optimization
