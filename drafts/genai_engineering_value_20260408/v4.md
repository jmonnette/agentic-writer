...
They care about one thing: did the money we spent on AI come back as more money? Most engineering leaders cannot answer that question. Not because the answer is bad — but because they've been measuring the wrong things and reporting them in the wrong language.
...
AI has made this dysfunction impossible to ignore. The sharpest evidence comes from a randomized controlled trial by METR (July 2025), studying experienced open-source developers using AI tools on their own codebases. The result: developers using AI tools took **19% longer** to complete tasks, while estimating they'd be 20% faster. That 39-point gap between perception and reality is the most important data point in the AI productivity debate — and it's almost entirely absent from the vendor presentations landing in your inbox.
...
Story points still belong as internal team coordination tools — sprint capacity planning, retrospective calibration, flow diagnosis. They have no business in a boardroom conversation about whether your AI investment is paying off.
...
What's the right recovery assumption? That's where most AI business cases go wrong. The METR RCT — experienced developers on familiar codebases — showed gains near zero or negative. LinearB's GitHub Copilot analysis (a productivity measurement vendor with incentive to be optimistic) suggests up to 20%. The honest version presents a range: ceiling near $2–2.5M, realistic case materially lower, depending on work type, developer experience, and codebase complexity. Use the range. Name the assumptions. Don't anchor on the optimistic case.
...
This is what attribution looks like in practice. It's not precise. It's not audited by your finance team. But it's directionally honest, names the methodology, and acknowledges confidence explicitly — and that is dramatically more useful to a CFO than a velocity trend. Not because the number is better, but because it's in the right unit with a stated methodology she can interrogate.
...
Yes, this is a process change — and a real one. It shifts the burden of business justification from CTOs scrambling to explain AI spend in quarterly reviews to product stakeholders at the moment work enters the backlog. That's where the burden belongs. It also requires product management maturity that many organizations don't yet have. Building it is a prerequisite, not a side effect.
...
Sixty-one percent of CEOs are facing board pressure for AI returns right now. Those boards are not becoming more patient — and in capital-constrained environments, where AI spend competes directly with headcount, the pressure arrives faster and with less runway. Engineering leaders who cannot answer in the board's language — not because AI isn't working, but because their reporting infrastructure is built around story points and DORA metrics — will lose budget, lose credibility, or both.

The organizations that will prove their AI returns through 2027 won't be the ones with the most sophisticated models or the largest tooling budgets. They'll be the ones that built measurement discipline first — into how requirements are written, how delivery is instrumented, how engineering value gets reported to the business.

The question isn't whether your AI investment is paying off. The question is whether you've built the infrastructure to know — and whether you can explain it in a language your board actually uses.
